...
export type InternalEventPayload =
  ...
  | { type: "boot_response" }
  | ({ type: "reload_response" } & ReloadResponse)
  ...
  | ({ type: "list_cookie_names_request" } & ListCookieNamesRequest)
  | ({ type: "list_cookie_names_response" } & ListCookieNamesResponse)
  | ({ type: "get_cookie_value_request" } & GetCookieValueRequest)
  | ({ type: "get_cookie_value_response" } & GetCookieValueResponse)
  ...
  | ({ type: "get_websocket_request_actions_request" } & EmptyPayload)
  | ({ type: "get_websocket_request_actions_response" } & GetWebsocketRequestActionsResponse)
  | ({ type: "call_websocket_request_action_request" } & CallWebsocketRequestActionRequest)
  | ({ type: "get_workspace_actions_request" } & EmptyPayload)
  | ({ type: "get_workspace_actions_response" } & GetWorkspaceActionsResponse)
  | ({ type: "call_workspace_action_request" } & CallWorkspaceActionRequest)
  | ({ type: "get_folder_actions_request" } & EmptyPayload)
  | ({ type: "get_folder_actions_response" } & GetFolderActionsResponse)
  | ({ type: "call_folder_action_request" } & CallFolderActionRequest)
  | ({ type: "get_grpc_request_actions_request" } & EmptyPayload)
  | ({ type: "get_grpc_request_actions_response" } & GetGrpcRequestActionsResponse)
  | ({ type: "call_grpc_request_action_request" } & CallGrpcRequestActionRequest)
  | ({ type: "get_template_function_summary_request" } & EmptyPayload)
  | ({ type: "get_template_function_summary_response" } & GetTemplateFunctionSummaryResponse)
  | ({ type: "get_template_function_config_request" } & GetTemplateFunctionConfigRequest)
  | ({ type: "get_template_function_config_response" } & GetTemplateFunctionConfigResponse)
  ...
  | ({ type: "get_http_authentication_summary_request" } & EmptyPayload)
  | ({ type: "get_http_authentication_summary_response" } & GetHttpAuthenticationSummaryResponse)
  | ({ type: "get_http_authentication_config_request" } & GetHttpAuthenticationConfigRequest)
  | ({ type: "get_http_authentication_config_response" } & GetHttpAuthenticationConfigResponse)
  | ({ type: "call_http_authentication_request" } & CallHttpAuthenticationRequest)
  | ({ type: "call_http_authentication_response" } & CallHttpAuthenticationResponse)
  | ({ type: "call_http_authentication_action_request" } & CallHttpAuthenticationActionRequest)
  | ({ type: "call_http_authentication_action_response" } & EmptyPayload)
  | ({ type: "copy_text_request" } & CopyTextRequest)
  | ({ type: "copy_text_response" } & EmptyPayload)
  | ({ type: "render_http_request_request" } & RenderHttpRequestRequest)
  | ({ type: "render_http_request_response" } & RenderHttpRequestResponse)
  | ({ type: "render_grpc_request_request" } & RenderGrpcRequestRequest)
  | ({ type: "render_grpc_request_response" } & RenderGrpcRequestResponse)
  | ({ type: "template_render_request" } & TemplateRenderRequest)
  | ({ type: "template_render_response" } & TemplateRenderResponse)
  | ({ type: "get_key_value_request" } & GetKeyValueRequest)
  | ({ type: "get_key_value_response" } & GetKeyValueResponse)
  | ({ type: "set_key_value_request" } & SetKeyValueRequest)
  | ({ type: "set_key_value_response" } & SetKeyValueResponse)
  | ({ type: "delete_key_value_request" } & DeleteKeyValueRequest)
  | ({ type: "delete_key_value_response" } & DeleteKeyValueResponse)
  | ({ type: "open_window_request" } & OpenWindowRequest)
  | ({ type: "window_navigate_event" } & WindowNavigateEvent)
  | { type: "window_close_event" }
  | ({ type: "close_window_request" } & CloseWindowRequest)
  | ({ type: "open_external_url_request" } & OpenExternalUrlRequest)
  | ({ type: "open_external_url_response" } & EmptyPayload)
  | ({ type: "show_toast_request" } & ShowToastRequest)
  | ({ type: "show_toast_response" } & EmptyPayload)
  | ({ type: "prompt_text_request" } & PromptTextRequest)
  | ({ type: "prompt_text_response" } & PromptTextResponse)
  | ({ type: "prompt_form_request" } & PromptFormRequest)
  | ({ type: "prompt_form_response" } & PromptFormResponse)
  | ({ type: "window_info_request" } & WindowInfoRequest)
  | ({ type: "window_info_response" } & WindowInfoResponse)
  | ({ type: "list_open_workspaces_request" } & ListOpenWorkspacesRequest)
  | ({ type: "list_open_workspaces_response" } & ListOpenWorkspacesResponse)
  ...
  | ({ type: "get_http_response_body_info_request" } & GetHttpResponseBodyInfoRequest)
  | ({ type: "get_http_response_body_info_response" } & GetHttpResponseBodyInfoResponse)
  | ({ type: "read_http_response_body_chunk_request" } & ReadHttpResponseBodyChunkRequest)
  | ({ type: "read_http_response_body_chunk_response" } & ReadHttpResponseBodyChunkResponse)
  | ({ type: "list_http_requests_request" } & ListHttpRequestsRequest)
  | ({ type: "list_http_requests_response" } & ListHttpRequestsResponse)
  | ({ type: "list_folders_request" } & ListFoldersRequest)
  | ({ type: "list_folders_response" } & ListFoldersResponse)
  | ({ type: "upsert_model_request" } & UpsertModelRequest)
  | ({ type: "upsert_model_response" } & UpsertModelResponse)
  | ({ type: "delete_model_request" } & DeleteModelRequest)
  | ({ type: "delete_model_response" } & DeleteModelResponse)
  | ({ type: "get_themes_request" } & GetThemesRequest)
  | ({ type: "get_themes_response" } & GetThemesResponse)
  | ({ type: "empty_response" } & EmptyPayload)
...
export type PromptFormResponse = {
  values: { [key in string]?: JsonPrimitive } | null;
  done?: boolean;
};
 ...
 */
export type ReadHttpResponseBodyChunkRequest = {
  responseId: string;
  offset: number;
  length: number;
};
